# 公司内接入指南 Task Boundary

- Task: 公司内接入指南
- 负责人: Codex
- 日期: 2026-06-11
- 相关 issue / doc: `.gstack/requirements/2026-06-11_company-adoption-guide-fast-lane-requirement.md`

## Goal

- 补充公司内发放和新项目接入 KK Dev Skeleton 的可执行指南与验收检查清单。

## Allowed Files

- .gstack/requirements/2026-06-11_company-adoption-guide-fast-lane-requirement.md
- .gstack/reviews/2026-06-11_company-adoption-guide-fast-lane-review.md
- .gstack/task-boundaries/2026-06-11_company-adoption-guide.md
...
- Expected Visible Behavior:
  - 仓库首页能看到公司内接入指南入口。
  - `COMPANY_ADOPTION_GUIDE.md` 能说明发放包、接入步骤、adapter 填写清单、接入成功标准、试点任务和安全边界。
- User Actions To Verify:
  - 打开 `README.md`，确认能找到 `COMPANY_ADOPTION_GUIDE.md` 链接。
  - 打开 `COMPANY_ADOPTION_GUIDE.md`，确认新团队能按文档完成接入。
- Required Evidence:
  `CLI 输出 / 文档内容检查 / rg 检查`
...
- requirement-brief:
  status: done
  evidence: `.gstack/requirements/2026-06-11_company-adoption-guide-fast-lane-requirement.md`
- plan-ceo-review:
  status: done
  evidence: `.gstack/reviews/2026-06-11_company-adoption-guide-fast-lane-review.md`
- requirement-freeze:
  status: done
  evidence: `.gstack/requirements/2026-06-11_company-adoption-guide-fast-lane-requirement.md`
...
- domain-spec-readiness:
  status: not-required
  evidence: `.gstack/task-boundaries/2026-06-11_company-adoption-guide.md`
...
- qa:
  status: done
  command: qa-only
  evidence: `.gstack/qa-reports/2026-06-11_company-adoption-guide-qa.md`
...
required_gates:
  - gate_id: data-access
    ...
    status: not-required
    evidence_path: ".gstack/task-boundaries/2026-06-11_company-adoption-guide.md"
